...
secondChoiceButton.addEventListener("click", () => {
  firstChoiceButton.classList.remove("active-choice"); // Entferne "active" vom ersten Button
  secondChoiceButton.classList.add("active-choice");   // Füge "active" dem zweiten Button hinzu
  console.log('%c Selected second choice 💅', 'color: green; font-weight: bold; backround-color: black;');               // Logge die Auswahl in der Konsole
});
